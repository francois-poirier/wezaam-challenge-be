...
public class WithdrawalProcessingConsumerTest {
    ...
    public static final String PROCESSING_STATUS = WithdrawalStatus.PROCESSING.toString();
    private WithdrawalProducer withdrawalProducer;
    private WithdrawalRepository withdrawalRepository;
    private WithdrawalProcessingConsumer sut;
    ...
    public void setUp() {
        ...
        this.sut = new WithdrawalProcessingConsumer(withdrawalProducer,withdrawalRepository);
    }
    ...
    private Withdrawal createWithdrawal() {
        return new Withdrawal.Builder()
                ...
                .withStatus(WithdrawalStatus.PROCESSING)
                .build();
    }
